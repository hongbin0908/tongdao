...
public class MissionDietActivity extends Activity{
	...
	Handler dateandtimeHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case MissionDietActivity.SHOW_DATAPICK_START:
				showDialog(DATE_DIALOG_ID_START);
				break;
			case MissionDietActivity.SHOW_DATAPICK_END:
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mission_diet_main);
		...
		elMissionDietMainStart.getEditText().setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {	
					...
					if (elMissionDietMainStart.getEditText().equals((EditText) v)) {
						msg.what = MissionDietActivity.SHOW_DATAPICK_START;
					}
					MissionDietActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
		...
		elMissionDietMainEnd.getEditText().setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {	
					...
					if (elMissionDietMainEnd.getEditText().equals((EditText) v)) {
						msg.what = MissionDietActivity.SHOW_DATAPICK_END;
					}
					MissionDietActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
		...
		bnMissionDietMainSubbmit.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				new AlertDialog.Builder(MissionDietActivity.this)  
				.setTitle("创建任务")  
				.setMessage("您创建了减肥任务，开始时间为" + getDateDisplay(mStartYear, mStartMonth, mStartDay) + ",结束时间为"
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog, int which) {
			            ...
			            intent.setClass(MissionDietActivity.this, MainActivity.class);
			            intent.putExtra("tab", 0);  
			            MissionDietActivity.this.startActivity(intent);
